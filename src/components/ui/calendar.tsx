  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-xs font-medium text-fg",
        ...
        selected:
          "bg-accent text-accent-fg hover:bg-accent hover:text-accent-fg focus:bg-accent focus:text-accent-fg",
        today: "bg-muted text-fg",
        outside:
