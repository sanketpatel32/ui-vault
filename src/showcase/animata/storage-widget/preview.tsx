  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 text-center">
      <div className="w-full max-w-sm rounded-2xl border border-border bg-panel p-6 shadow-xs space-y-3">
        ...
        <h4 className="text-base font-semibold text-fg tracking-tight">Storage Widget</h4>
        <p className="text-xs text-muted-fg leading-relaxed">A widget to display storage</p>
      </div>
    </div>
  );
}
