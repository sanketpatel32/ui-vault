...
function buildClassificationQueue(count: number): ClassificationRow[] {
  return Array.from({ length: count }, (_, index) => {
    const product = classificationProducts[index % classificationProducts.length];
    const status =
...
export const classificationQueue: ClassificationRow[] = buildClassificationQueue(56);

export type ReportStatus = "completed" | "processing";

export type ReportType = "cf-28" | "cf-29" | "classification-audit" | "compliance-summary";
