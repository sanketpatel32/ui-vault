  ...
  return (
    <div className="p-8 space-y-12">
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm text-muted-foreground">Adjust the size when collapsed and expanded</p>
        <div className="flex justify-center items-center min-h-[300px]  rounded-lg p-8">
          <MorphSurface
            collapsedWidth="auto"
            collapsedHeight={48}
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm text-muted-foreground">Add an icon to the trigger button</p>
        <div className="flex justify-center items-center min-h-[300px]  rounded-lg p-8">
          <MorphSurface
            triggerLabel="Help"
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm text-muted-foreground">Control the open/close state externally</p>
