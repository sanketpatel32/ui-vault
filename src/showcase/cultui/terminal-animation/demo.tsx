...
import {
  ...
  type TabContent,
  type TerminalLine,
} from "./terminal-animation";

// Adapted from the official cult-ui demo:
// https://github.com/nolly-studio/cult-ui (apps/www/public/r/terminal-animation-demo.json)
// Local adaptation: the upstream background image asset is not vendored, so
// the demo renders the built-in gradient background instead.
