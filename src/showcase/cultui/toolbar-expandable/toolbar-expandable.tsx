  ...
  function DynamicToolbarExpandable({
    ...
    const scrollButtonIntoView = useCallback(
      (currentIndex: number, previousIndex: number | null) => {
        ...
        const isMovingForward = previousIndex !== null && currentIndex > previousIndex;
        const isMovingBackward = previousIndex !== null && currentIndex < previousIndex;
    ...
    const handleNavClick = useCallback(
      ...
      [active, isOpen, steps, scrollButtonIntoView, previousIndex, setActive, setIsOpen],
    );
...
function useMeasure(): [(node: HTMLElement | null) => void, Bounds, () => void] {
