  ...
  return (
    <>
      <header className="mb-4 flex h-[72px] items-center border-b border-border pl-2">
        <h2 className="text-[19px] font-semibold text-foreground md:font-medium">Custom Menu</h2>
      </header>
      <div className="space-y-3">
        <FamilyDrawerButton onClick={() => setView("settings")}>⚙️ Settings</FamilyDrawerButton>
        <FamilyDrawerButton onClick={() => setView("profile")}>👤 Profile</FamilyDrawerButton>
        <FamilyDrawerButton onClick={() => setView("about")}>ℹ️ About</FamilyDrawerButton>
      </div>
    </>
  );
}
    ...
    <div className="px-2">
      ...
      <div className="mt-6 space-y-4 border-t border-border pt-6">
        ...
        <p className="mt-4 text-sm text-muted-foreground">
          This view has more content to demonstrate height differences between views.
        </p>
      </div>
      <div className="mt-7 flex gap-4">
        <FamilyDrawerSecondaryButton
...
function MinimalView() {
  ...
  return (
    <div className="px-2 py-4">
      ...
      <p className="mt-2 text-sm text-muted-foreground">A simple, minimal view example.</p>
      <button
        type="button"
        onClick={() => setView("default")}
...
export function MinimalExample() {
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-muted-foreground">A simple, single-view drawer</p>
        ...
        <div className="mt-6 space-y-4 border-t border-border pt-6">
          <div className="rounded-lg bg-muted/30 p-4">
            ...
            <p className="mt-2 text-xs text-muted-foreground">
              Your files will be uploaded securely. You can access them anytime from your dashboard.
            </p>
          </div>
    ...
    <div>
      <div className="px-2">
        ...
        <div className="mt-6 space-y-4 border-t border-border pt-6">
          ...
          <p className="mt-4 text-sm text-muted-foreground">
            You can now access your files from the dashboard or upload more files.
          </p>
        </div>
      </div>
      <div className="mt-7 flex gap-4">
      ...
      <div className="px-2">
        ...
        <div className="mt-6 space-y-4 border-t border-border pt-6">
          <div className="rounded-lg bg-destructive/10 p-4">
            ...
            <p className="mt-2 text-xs text-muted-foreground">
              Deleting your account will permanently remove all your data, including files,
              settings, and history. This action cannot be reversed.
            </p>
          </div>
          <div className="space-y-2 text-sm">
      ...
      <div className="px-2">
        ...
        <div className="mt-6 space-y-4 border-t border-border pt-6">
          <div className="rounded-lg bg-destructive/10 p-4">
            ...
            <p className="mt-2 text-xs text-muted-foreground">
              To confirm, please type <strong>{CONFIRMATION_WORD}</strong> in the field below.
            </p>
          </div>
          <div>
            <label
      ...
      <div className="px-2">
        ...
        <div className="mt-6 space-y-4 border-t border-border pt-6">
          <div className="rounded-lg border-2 border-destructive bg-destructive/10 p-4">
            ...
            <p className="mt-2 text-xs text-muted-foreground">
              This is your last opportunity to cancel. Once you proceed, your account and all
              associated data will be permanently deleted immediately.
            </p>
          </div>
          <div className="space-y-3 text-sm">
            ...
            <div className="flex items-start gap-2">
              <AlertTriangle className="size-4 mt-0.5 text-destructive" />
              <span className="text-muted-foreground">
                You will need to create a new account if you want to use our service again
              </span>
            </div>
          </div>
        </div>
  ...
  return (
    <div>
      <div className="px-2">
        ...
        <div className="mt-6 space-y-4 border-t border-border pt-6">
          <div className="rounded-lg bg-destructive/10 p-4">
            <p className="text-sm font-medium text-destructive">Account deletion complete</p>
            <p className="mt-2 text-xs text-muted-foreground">
              All your data has been permanently removed from our systems. You will need to create a
              new account if you wish to use our service again.
            </p>
          </div>
          <div className="space-y-2 text-sm">
            <div className="flex items-center gap-2 text-muted-foreground">
