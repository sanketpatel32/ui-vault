      ...
      <div className="max-w-6xl w-full">
        <div className="text-center space-y-4 mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Explore different texture patterns using CSS gradients for adding visual texture to
            ...
            >
              ...
              <div className="relative z-10 p-6 h-full flex items-end">
                <div className="bg-background/80 backdrop-blur-sm rounded-md px-3 py-2 border">
                  <h3 className="font-medium text-foreground">{texture.name}</h3>
                  <p className="text-sm text-muted-foreground">{texture.type} texture</p>
                </div>
              </div>
            </div>
          ))}
            ...
            {[0.3, 0.6, 1.0].map((opacity) => (
              ...
              >
                ...
                <div className="relative z-10 p-4 h-full flex items-end">
                  <div className="bg-background/80 backdrop-blur-sm rounded-md px-3 py-2 border">
                    <h4 className="font-medium text-foreground">Dots Pattern</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="relative h-32 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 overflow-hidden">
              ...
              <div className="relative z-10 p-4 h-full flex items-center justify-center">
                <div className="bg-background/80 backdrop-blur-sm rounded-md px-3 py-2 border">
                  <h4 className="font-medium text-foreground">Grid with Blend Mode</h4>
                  <p className="text-sm text-muted-foreground">mix-blend-overlay</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative h-32 rounded-lg bg-gradient-to-br from-green-500 to-teal-600 overflow-hidden">
              ...
              <div className="relative z-10 p-4 h-full flex items-center justify-center">
                <div className="bg-background/80 backdrop-blur-sm rounded-md px-3 py-2 border">
                  <h4 className="font-medium text-foreground">Noise with Custom Opacity</h4>
                  <p className="text-sm text-muted-foreground">opacity-50 class</p>
                </div>
              </div>
            </div>
          </div>
