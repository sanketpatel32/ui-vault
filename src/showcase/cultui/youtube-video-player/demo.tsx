    ...
    <div className="space-y-12 p-8">
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground">
          A collection of YouTube video player examples showcasing different configurations and
          styling options.
        </p>
      </div>
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <YouTubePlayer videoId="9bZkp7q19f0" title="PSY - GANGNAM STYLE" className="w-full" />
          <YouTubePlayer
            videoId="fJ9rUzIMcZQ"
            title="Queen – Bohemian Rhapsody"
            className="w-full"
          />
          <YouTubePlayer videoId="L_jWHffIx5E" title="Smash Mouth - All Star" className="w-full" />
          <YouTubePlayer
            videoId="hTWKbfoikeg"
            title="Nirvana - Smells Like Teen Spirit"
            className="w-full"
          />
          <YouTubePlayer videoId="djV11Xbc914" title="a-ha - Take On Me" className="w-full" />
          <YouTubePlayer
            videoId="ZbZSe6N_BXs"
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <div className="w-[300px]">
              <YouTubePlayer videoId="2yJgwwDcgV8" title="Nyan Cat [original]" />
            </div>
          </div>
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Regular video ID */}
          <div>
            <h3 className="text-sm font-medium mb-2">Video ID: "dQw4w9WgXcQ"</h3>
          ...
          {/* Short URL */}
          <div>
            <h3 className="text-sm font-medium mb-2">Short URL: "https://youtu.be/dQw4w9WgXcQ"</h3>
            <YouTubePlayer videoId="https://youtu.be/dQw4w9WgXcQ" title="Using Short YouTube URL" />
          </div>
        </div>
      </section>
