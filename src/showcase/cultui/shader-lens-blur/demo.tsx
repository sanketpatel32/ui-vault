...
import { Separator } from "@/showcase/_shared/cultui/ui/separator";
import { Slider } from "@/showcase/_shared/cultui/ui/slider";
import { Switch } from "@/showcase/_shared/cultui/ui/switch";

import ColorPicker from "../color-picker";
import ShaderLensBlur, { configAtom } from "./shader-lens-blur";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-6">
            <div className="space-y-4">
              <Label htmlFor={variationId} className="text-sm font-medium text-muted-foreground">
                Variation
              </Label>
              <Select value={config.variation.toString()} onValueChange={handleVariationChange}>
                <SelectTrigger id={variationId} className="w-full border-border bg-background">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                {(["color1", "color2", "color3", "color4"] as const).map((color) => (
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <Label htmlFor={widthId} className="text-sm font-medium text-muted-foreground">
                      Width
                    </Label>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <Label htmlFor={heightId} className="text-sm font-medium text-muted-foreground">
                      Height
                    </Label>
