  ...
  return (
    <div className="dark:bg-stone-950 flex flex-col items-center gap-12 rounded-md px-4 py-6 md:px-0">
      <div className="max-w-2xl space-y-2 text-center">
        <h2 className="text-foreground text-2xl font-bold tracking-tight">SVG shapes</h2>
        <p className="text-muted-foreground text-sm">
          Wide viewBox line-art panels for landing pages: polygons, architectural silhouettes,
          sacred geometry, and Platonic wire projections. Shape via{" "}
          <code className="bg-muted rounded px-1 py-0.5 text-xs">currentColor</code> and light fill
          tints; pass <code className="bg-muted rounded px-1 py-0.5 text-xs">flip</code> to mirror
