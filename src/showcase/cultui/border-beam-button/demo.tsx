    ...
    <div className="mx-auto w-full max-w-3xl space-y-10 px-4 py-8 md:px-6">
      <header className="space-y-2 text-center">
        ...
        <p className="mx-auto max-w-lg text-pretty text-muted-foreground text-sm leading-relaxed">
          ...
          <span className="text-foreground/90">borderBeamClassName</span> styles the beam wrapper.
          Use <span className="text-foreground/90">colorVariant</span>,{" "}
      ...
      <div className="">
        <Section description="Same outline button; swap the beam palette." title="Beam color">
          <div className="flex flex-wrap items-center justify-center gap-3">
            {COLOR_ROW.map(({ key, label }) => (
              <BorderBeamButton colorVariant={key} key={key} type="button" variant="outline">
                {label}
              </BorderBeamButton>
            ))}
          </div>
      ...
      <div className="">
        ...
        >
          <div className="flex flex-wrap items-center justify-center gap-3">
            {BEAM_SIZES.map((size) => (
              <BorderBeamButton beamSize={size} key={size} type="button" variant="outline">
