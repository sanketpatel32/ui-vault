...
export const BorderBeamButton = forwardRef<HTMLDivElement, BorderBeamButtonProps>(
...
export const BorderBeamIconButton = forwardRef<HTMLDivElement, BorderBeamIconButtonProps>(
