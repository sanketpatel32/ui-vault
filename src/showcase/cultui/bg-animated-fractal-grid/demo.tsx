...
import { FractalDotGrid } from "./bg-animated-fractal-dot-grid";
  ...
  return (
    <div className="container mx-auto py-8">
      <div className="grid grid-cols-1  gap-8">
        <div>
          <Button variant="outline" size="sm" onClick={copyConfigToClipboard} className="mb-4">
                    ...
                    {config.enableNoise && (
                      <div>
                        ...
                        <Slider
                          ...
                          onValueChange={([value]) => updateConfig("noiseOpacity", value)}
                        />
                      </div>
                    )}
                    <div className="flex items-center space-x-2">
