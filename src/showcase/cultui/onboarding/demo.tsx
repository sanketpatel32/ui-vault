...
import { ChoiceGroup, FeatureCarousel, Onboarding, TipsList, useOnboarding } from "./onboarding";
...
export const FEATURES = [
  ...
  },
  {
    ...
    description: "Copy agent skills and critical files to supercharge your AI-powered workflows.",
      ...
      <Dialog onOpenChange={setOpen} open={open}>
        ...
        >
          <div className="w-full rounded-2xl bg-muted p-[2px] md:p-2">
            <Onboarding
              canGoNext={(step) =>
                step === 1 || (step === 2 && selectedGoal !== null) || step === 3
              }
      ...
      {question === 1 ? (
        <div className="flex flex-col gap-4" key="q1">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium text-base text-foreground">What best describes you?</span>
          </div>
          <ChoiceGroup
