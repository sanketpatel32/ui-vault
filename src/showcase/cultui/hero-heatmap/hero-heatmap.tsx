...
export interface HeroHeatmapRootProps
  extends Omit<React.ComponentPropsWithoutRef<"section">, "title">, HeroHeatmapShaderOverrides {
  srTitle?: string;
...
export function HeroHeatmapContent({ className, ...props }: React.ComponentPropsWithoutRef<"div">) {
  return (
    <div
      className={cn(
