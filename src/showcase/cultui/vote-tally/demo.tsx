...
import { VoteTally, type VoteTallyValue } from "./vote-tally";
...
export function VoteTallyExample() {
  ...
  const [votedItems, setVotedItems] = useState<Set<string>>(new Set(["dark-mode"]));
      ...
      >
        {[
          ...
          <VoteTally.Item
            ...
            value={feature.id}
          >
            <VoteTally.Title className="text-foreground text-sm">{feature.title}</VoteTally.Title>
