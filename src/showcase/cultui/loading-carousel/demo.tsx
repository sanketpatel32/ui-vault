import { CardContent, CardHeader, CardTitle } from "@/showcase/_shared/cultui/ui/card";
  ...
  return (
    <div className="space-y-8 p-4 w-full">
      ...
      <div className="w-full">
        ...
        <CardContent>
          <LoadingCarousel aspectRatio="wide" backgroundTips={true} backgroundGradient={true} />
        </CardContent>
      </div>
      ...
      <div className="w-full">
        ...
        <CardContent>
          <LoadingCarousel shuffleTips={true} autoplayInterval={3000} showProgress={false} />
        </CardContent>
      </div>
      ...
      <div className="w-full">
        ...
        <CardContent>
          <LoadingCarousel aspectRatio="square" backgroundTips={true} backgroundGradient={true} />
        </CardContent>
      </div>
    </div>
  );
