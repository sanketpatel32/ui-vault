  ...
  return (
    <div className="dark:bg-stone-950 flex flex-col items-center gap-12 rounded-md px-4 py-6 md:px-0">
      <div className="max-w-2xl space-y-2 text-center">
        <h2 className="text-foreground text-2xl font-bold tracking-tight">SVG bands</h2>
        <p className="text-muted-foreground text-sm">
          Wide (2400-based) section ornaments: battlement and zigzag trims, steep hero headers, and
          frame panels. Styling follows{" "}
          <code className="bg-muted rounded px-1 py-0.5 text-xs">currentColor</code> with light fill
          tints — pair with your background and type color.
        </p>
      </div>
