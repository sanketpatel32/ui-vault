...
import { TextureCardContent, TextureCardHeader, TextureCardStyled } from "../texture-card";
    ...
    <TextureCardStyled>
      ...
      <TextureCardContent>
        <div className="flex gap-2">
          <div className="text-2xl font-bold" style={{ minWidth: "80px", textAlign: "left" }}>
...
function FormatExample() {
  ...
  return (
    <TextureCardStyled>
      ...
      <TextureCardContent>
        <div className="flex gap-2">
          <div className="text-2xl font-bold" style={{ minWidth: "120px", textAlign: "left" }}>
...
function HooksExample() {
  ...
  return (
    <TextureCardStyled>
      ...
      <TextureCardContent>
        <div className="flex gap-2">
          <div className="text-2xl font-bold" style={{ minWidth: "50px", textAlign: "left" }}>
            <AnimatedNumber
              value={value}
...
function CustomSpringExample() {
  ...
  const handleValueChange =
    (setter: (value: number) => void, minValue: number) => (values: number[]) => {
  ...
  return (
    <TextureCardStyled className="w-full">
      ...
      <TextureCardContent className="flex flex-col sm:flex-row justify-between items-center gap-8">
        ...
        >
          <AnimatedNumber value={value} mass={mass} stiffness={stiffness} damping={damping} />
        </div>
