...
import { FeatureVoting, type FeatureVotingValue } from "./feature-voting";
...
function FeatureVotingExample() {
  ...
  const [votedFeatures, setVotedFeatures] = useState<Set<string>>(new Set(["dark-mode"]));
  ...
  return (
    <div className="w-full max-w-md">
      ...
      >
        <FeatureVoting.Group className="flex flex-col gap-2" sortBy="votes-desc">
  ...
  return (
    <div className="w-full max-w-sm">
      <FeatureVoting.Root className="flex flex-col gap-2">
        ...
        >
          <div className="flex min-w-0 flex-col gap-0.5">
            <FeatureVoting.Title className="font-medium text-sm">Dark mode</FeatureVoting.Title>
...
function FeatureVotingSortedExample() {
  return (
    <div className="w-full max-w-sm">
      <FeatureVoting.Root className="flex flex-col gap-2" defaultValue={{ a: 2, b: 5, c: 1 }}>
        <FeatureVoting.Group className="flex flex-col gap-2" sortBy="votes-desc">
          {[
            { id: "a", title: "Option A" },
            { id: "b", title: "Option B" },
            ...
            <FeatureVoting.Item
              ...
              value={feature.id}
            >
              <FeatureVoting.Title className="text-sm">{feature.title}</FeatureVoting.Title>
              <div className="flex items-center gap-2">
                <FeatureVoting.Count className="tabular-nums text-sm" />
                <FeatureVoting.Trigger className="rounded-md border px-2 py-1 text-sm">
                  Vote
