...
import { Badge } from "@/showcase/_shared/cultui/ui/badge";
...
const defaultDescription = (
  <>
    Full-stack vercel ai sdk patterns for workflows, tool calling, and agent orchestration. Built
    with <span className="font-medium tracking-tight">ai sdk v6</span> and{" "}
...
const HeroColorPanelsContext = React.createContext<HeroColorPanelsContextValue | undefined>(
  undefined,
);
...
export const HeroColorPanelsRoot = React.forwardRef<HTMLElement, HeroColorPanelsRootProps>(
  (
    {
      className,
      children,
