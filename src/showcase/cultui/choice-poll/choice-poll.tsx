...
function ChoicePollProgress({ className, ...props }: ChoicePollProgressProps) {
  ...
  return (
    <span
      aria-hidden="true"
      className={cn("h-1.5 w-16 overflow-hidden rounded-full bg-muted", className)}
...
function ChoicePollFooter({ children, className, totalVotes, ...props }: ChoicePollFooterProps) {
  ...
  return (
    <div
      className={cn("flex items-center justify-between text-muted-foreground text-sm", className)}
