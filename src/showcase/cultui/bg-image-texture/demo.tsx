...
import {
  ...
  CardHeader,
  CardTitle,
} from "@/showcase/_shared/cultui/ui/card";
import { Label } from "@/showcase/_shared/cultui/ui/label";
import { Slider } from "@/showcase/_shared/cultui/ui/slider";
import { BackgroundImageTexture } from "../bg-image-texture";
import type { TextureVariant } from "../bg-image-texture";
...
export default function BackgroundImageTextureDemo() {
  const [selectedVariant, setSelectedVariant] = useState<TextureVariant>("fabric-of-squares");
    ...
    <div className="space-y-8 p-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Select a texture variant and adjust the opacity</CardDescription>
        </CardHeader>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>See how the texture looks with content on top</CardDescription>
            </div>
        ...
        <CardContent>
          ...
          >
            <div className="space-y-6">
              <div>
                <h3 className="text-3xl font-bold text-foreground mb-2">Texture Background</h3>
                <p className="text-muted-foreground text-lg">
                  This content sits on top of the texture layer. Adjust the opacity slider to see
                  how the texture affects the background. The texture is fully interactive and
                  customizable.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-card/50 border border-border">
                  ...
                  <p className="text-sm text-muted-foreground">Content with texture background</p>
                </div>
                <div className="p-4 rounded-lg bg-card/50 border border-border">
                  <h4 className="font-semibold mb-2">Feature 2</h4>
                  <p className="text-sm text-muted-foreground">More content examples</p>
                </div>
              </div>
            </div>
          </BackgroundImageTexture>
                ...
                <CardContent>
                  ...
                  >
                    <div className="text-center">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">Opacity: 0.5</p>
                    </div>
                  </BackgroundImageTexture>
                </CardContent>
              </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[0.2, 0.5, 0.8].map((opacityValue) => (
            <Card key={opacityValue}>
              <CardHeader>
                <CardTitle className="text-lg">Opacity: {opacityValue}</CardTitle>
              </CardHeader>
              <CardContent>
                <BackgroundImageTexture
                  variant="grid-noise"
                ...
                >
                  <div className="text-center">
                    <p className="text-sm font-medium text-foreground">grid-noise texture</p>
                    <p className="text-xs text-muted-foreground mt-1">Opacity: {opacityValue}</p>
                  </div>
                </BackgroundImageTexture>
              </CardContent>
            </Card>
