      ...
      <PopoverForm
        ...
        openChild={
          ...
          >
            ...
            <PopoverFormButton loading={formState === "loading"} text="Subscribe" />
          </form>
        }
        successChild={
          <PopoverFormSuccess
  ...
  return (
    <div className="flex w-full items-center justify-center">
      <PopoverForm
        ...
        openChild={
          <div className="p-2">
            <h3 className="text-sm tracking-tight text-muted-foreground">Theme</h3>
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center px-3 py-2 text-sm rounded-md ${
                      isSelected
                        ? `bg-primary ${effectiveTheme === "light" ? "text-white" : "text-black"}`
