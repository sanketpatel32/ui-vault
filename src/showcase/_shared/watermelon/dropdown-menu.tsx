...
type DropdownMenuPrimitiveProps = React.ComponentProps<typeof DropdownMenuPrime.Root>;
...
function DropdownMenuPrimitive(props: DropdownMenuPrimitiveProps) {
  ...
  return (
    <DropdownMenuProvider value={{ isOpen, setIsOpen, highlightedValue, setHighlightedValue }}>
      <DropdownMenuPrime.Root data-slot="dropdown-menu" {...props} onOpenChange={setIsOpen} />
    </DropdownMenuProvider>
  );
}

type DropdownMenuTriggerPrimitiveProps = React.ComponentProps<typeof DropdownMenuPrime.Trigger>;

function DropdownMenuTriggerPrimitive(props: DropdownMenuTriggerPrimitiveProps) {
  return <DropdownMenuPrime.Trigger data-slot="dropdown-menu-trigger" {...props} />;
}

type DropdownMenuPortalPrimitiveProps = React.ComponentProps<typeof DropdownMenuPrime.Portal>;

function DropdownMenuPortalPrimitive(props: DropdownMenuPortalPrimitiveProps) {
  return <DropdownMenuPrime.Portal data-slot="dropdown-menu-portal" {...props} />;
}

type DropdownMenuGroupPrimitiveProps = React.ComponentProps<typeof DropdownMenuPrime.Group>;
...
type DropdownMenuSubPrimitiveProps = React.ComponentProps<typeof DropdownMenuPrime.Sub>;
...
function DropdownMenuSubPrimitive(props: DropdownMenuSubPrimitiveProps) {
  ...
  return (
    <DropdownMenuSubProvider value={{ isOpen, setIsOpen }}>
      <DropdownMenuPrime.Sub data-slot="dropdown-menu-sub" {...props} onOpenChange={setIsOpen} />
...
function DropdownMenuRadioGroupPrimitive(props: DropdownMenuRadioGroupPrimitiveProps) {
  return <DropdownMenuPrime.RadioGroup data-slot="dropdown-menu-radio-group" {...props} />;
}
...
type DropdownMenuLabelPrimitiveProps = React.ComponentProps<typeof DropdownMenuPrime.Label>;
...
type DropdownMenuSeparatorPrimitiveProps = React.ComponentProps<typeof DropdownMenuPrime.Separator>;

function DropdownMenuSeparatorPrimitive(props: DropdownMenuSeparatorPrimitiveProps) {
  return <DropdownMenuPrime.Separator data-slot="dropdown-menu-separator" {...props} />;
}
...
function DropdownMenuItemIndicatorPrimitive(props: DropdownMenuItemIndicatorPrimitiveProps) {
  return (
    <DropdownMenuPrime.ItemIndicator data-slot="dropdown-menu-item-indicator" asChild>
      <motion.div {...props} />
